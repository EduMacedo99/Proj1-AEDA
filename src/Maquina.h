...
#include "Utente.h"
 ...
 public:
	 ...
	 /**
	  * metodo que elimina bilhete assinatura do vetor bilhetesO com base no nome do utente
	  * @param nome do utente cujo bilhete assinatura sera elminado
	  */
	 void eraseBilheteO(string nome);
...
public:
		...
		/**
		 * metodo que devolve a posicao do Utente com um determinado nome
		 * @param nome nome do utente que se quer encontrar
		 * @return o indice do utente (-1 se nao existir)
		 */
		int findUtente(string nome) const;
		...
		*/
		...
		/**
		 * metodo que elimina bilhete assinatura do vetor bilhetesA com base no nome do utente
		 * @param nome nome do utente cujo bilhete assinatura sera elminado
		 */
		bool eraseBilheteA(string nome);
