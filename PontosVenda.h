...
public:
	...
	/**
	 * metodo que tenta encontrar um ponto de venda que esteja num determinado local, retornando esse elemento do vetor dos pontos de venda (se existir)
	 * @param local local onde queremos procurar o ponto de venda
	 */
	Maquina* findPDV(string local) const;
